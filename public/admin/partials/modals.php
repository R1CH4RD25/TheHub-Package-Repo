...
<div id="confirmModal" class="modal">
    <div class="modal-content" style="max-width: 400px;">
        ...
        <div class="modal-actions">
            ...
            <button type="button" id="confirmNo" class="btn btn-secondary modal-cancel">Cancel</button>
        </div>
    </div>
</div>
    ...
    <div class="modal-content">
        ...
        <form id="invitationForm">
            ...
            <div class="form-group">
                ...
                <input type="email" id="inviteEmail" name="email" required placeholder="user@woodsonisd.net">
                <small>Must be a @woodsonisd.net email address</small>
            </div>
            
            <div class="form-group">
                <label for="inviteRole">Initial Role *</label>
...
<div id="userRolesModal" class="modal">
    <div class="modal-content">
        ...
        <form id="userRolesForm">
            ...
            <div class="form-group">
                <label>User</label>
                <p id="roleUserName" style="font-weight: 600; color: var(--text-color); margin-bottom: 1rem;"></p>
            </div>
            
            <div class="form-group">
                <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">Platform-Wide Roles</label>
...
<div id="sectionAccessModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Manage Section Access</h2>
            <span class="modal-close">&times;</span>
        </div>
        <form id="sectionAccessForm">
            ...
            <div class="form-group">
                <label id="accessUserLabel">User</label>
                <p id="accessUserName" style="font-weight: 600; color: var(--text-color);"></p>
            </div>
            
            <div class="form-group">
                <label id="accessSectionLabel">Section</label>
                <p id="accessSectionName" style="font-weight: 600; color: var(--text-color);"></p>
            </div>
            
            <div class="form-group">
                <label for="accessRole">Role in this Section *</label>
                <select id="accessRole" name="role" required>
                ...
                <small>Staff has basic access, higher roles can manage data and settings.</small>
            </div>
            
            <div class="modal-actions">
                <button type="submit" class="btn btn-primary">Grant Access</button>
                <button type="button" id="revokeAccessBtn" class="btn btn-danger" style="display: none;">Revoke Access</button>
                <button type="button" class="btn btn-secondary modal-cancel">Cancel</button>
            </div>
        </form>
    </div>
    ...
    <div class="modal-content">
        ...
        <form id="sectionForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="sectionDisplayName" name="display_name" required placeholder="e.g., Travel Request">
                <small>The name users will see</small>
            </div>

            <div class="form-group" style="display: none;">
                <label for="sectionName">Section Slug *</label>
                <input type="text" id="sectionName" name="name" required placeholder="e.g., travel-request">
                <small>Auto-generated from Display Name (lowercase, hyphens only)</small>
            </div>

            <div class="form-group">
                <label for="sectionIcon">Icon *</label>
                <select id="sectionIcon" name="icon" required style="font-size: 1.2rem;">
                ...
                <small>Choose an icon that represents this section</small>
            </div>

            <div class="form-group">
                <label for="sectionDescription">Description</label>
                <textarea id="sectionDescription" name="description" rows="3" placeholder="Brief description of this section's purpose"></textarea>
            </div>

            <div class="form-group" style="display: none;">
                <label for="sectionBaseUrl">Base URL *</label>
                <input type="text" id="sectionBaseUrl" name="base_url" required placeholder="/modules/section-name/">
                <small>Path to section's index.php (e.g., /modules/facilities-management/)</small>
            </div>

            <div class="form-group">
                <label for="sectionSortOrder">Sort Order</label>
                <input type="number" id="sectionSortOrder" name="sort_order" value="0" min="0">
                <small>Lower numbers appear first</small>
            </div>

            <div class="form-group">
                <label>
                    <input type="checkbox" id="sectionIsActive" name="is_active" value="1" checked>
...
<div id="googleGroupModal" class="modal">
    <div class="modal-content" style="max-width: 500px; max-height: 90vh; overflow-y: auto;">
        <div class="modal-header">
            <h2>Add Google Group Mapping</h2>
            <span class="modal-close">&times;</span>
        </div>
        <form id="googleGroupForm">
            <div class="form-group">
                <label for="googleGroupEmail">Google Group Email *</label>
                <?php
                ...
                ?>
                <input type="text" id="googleGroupEmail" placeholder="group@<?php echo htmlspecialchars($primaryDomain); ?> or seniors*@<?php echo htmlspecialchars($primaryDomain); ?>" required>
                <small>Full group email address. Use * as wildcard (e.g., seniors*@<?php echo htmlspecialchars($primaryDomain); ?> matches seniors2024@<?php echo htmlspecialchars($primaryDomain); ?>, seniors2025@<?php echo htmlspecialchars($primaryDomain); ?>, etc.)</small>
            </div>
            
            <div class="form-group">
                <label style="display: block; margin-bottom: 0.75rem; font-weight: 600;">Assign Roles * (select one or more)</label>
                <div style="display: flex; flex-direction: column; gap: 0.5rem; max-height: 300px; overflow-y: auto; padding-right: 0.5rem; border: 1px solid var(--border-secondary); border-radius: 4px; padding: 0.5rem;">
                    <?php
            ...
            <div class="modal-actions" style="position: sticky; bottom: 0; background: white; padding-top: 1rem; margin-top: 1rem; border-top: 1px solid var(--border-secondary);">
...
<div id="microsoftGroupModal" class="modal">
    <div class="modal-content" style="max-width: 500px; max-height: 90vh; overflow-y: auto;">
        <div class="modal-header">
            <h2>Add Microsoft Group Mapping</h2>
            <span class="modal-close">&times;</span>
        </div>
        <form id="microsoftGroupForm">
            <div class="form-group">
                <label for="microsoftGroupId">Azure AD Group ID *</label>
                <input type="text" id="microsoftGroupId" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" required>
                <small>The Azure AD Group Object ID from Azure Portal → Groups. Note: Use Group ID, not the display name.</small>
            </div>
