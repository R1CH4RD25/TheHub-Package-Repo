...
<body class="admin-root">
    <div class="admin-shell">
        <?php
        // Build navigation items for Enterprise Sidebar
        $navItems = [];
        ...
        if ($isSuperAdmin || $userRole === 'admin') {
            $navItems[] = [
                'id' => 'command',
                'label' => htmlspecialchars($mgmtDisplayName),
                'icon' => htmlspecialchars($mgmtIcon),
                'url' => '/management/',
                'type' => 'link'
            ];
        }
        ...
        // Package Management
        if ($canSeeSectionAccess || $canSeeManageSections || ($isSuperAdmin || in_array($userRole, ['admin']))) {
            $navItems[] = [
                'id' => 'packages',
        ...
        require_once __DIR__ . '/../../src/Components/EnterpriseSidebar.php';
        ...
        <main class="admin-main">
            ...
            <?php if ($isSuperAdmin): ?>
                <div id="tab-package-manager" class="admin-tab">
                    <div class="tab-header">
        ...
        <?php
        // Enterprise Footer Component - Spans both grid columns
        require_once __DIR__ . '/../../src/Components/EnterpriseFooter.php';
