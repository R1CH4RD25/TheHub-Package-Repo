<?php
/**
 * Travel Reimbursement Section - Coming Soon
 */
...
Auth::requireSectionAccess('travel-reimbursement', 'staff');

$user = Auth::getCurrentUser();
$sectionRole = Auth::getUserSectionRole('travel-reimbursement');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Travel Reimbursement - Woodson ISD</title>
...
<body>
    ...
    <div class="coming-soon-container">
        ...
        <h1 class="coming-soon-title">Travel Reimbursement</h1>
        <p class="coming-soon-subtitle">Coming Soon</p>
        <p class="coming-soon-description">
            This section will streamline the process of submitting and managing travel reimbursement requests. 
            Features will include expense tracking, receipt uploads, mileage calculations, approval workflows, and automated reimbursement processing.
        </p>
