<?php $__env->startSection('title', 'Configure ' . ($package['display_name'] ?? 'Package')); ?>

<?php $__env->startSection('content'); ?>
<div class="admin-tab active">
    <div class="tab-header">
        <div>
            <h1><i class="fas fa-cog"></i> Configure <?php echo e($package['display_name'] ?? 'Package'); ?></h1>
...
<script>
const packageId = '<?php echo e($packageId); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/woodson/thehub/resources/views/admin/package-configure-detail.blade.php ENDPATH**/ ?>